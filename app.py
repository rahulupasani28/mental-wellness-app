...
# Hard-coded Groq API key (replace with your actual key; note: hard-coding is not recommended for production)
groq_api_key = "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"  # Replace this with your actual Groq API key

if not groq_api_key or groq_api_key == "your_groq_api_key_here":
    st.error("Please replace 'your_groq_api_key_here' with your actual Groq API key in the code.")
    st.stop()
...
llm = ChatGroq(
    ...
    model_name="llama-3.3-70b-versatile",  # Updated to the recommended non-deprecated model
    temperature=0.7
)
